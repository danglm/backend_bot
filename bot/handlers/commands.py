        ...
        # ===================== TIẾN NGA =====================
            ...
            if custom_title == "member_supplier":
                ...
                commands_to_set.extend([
                    ...
                    BotCommand("tien_nga_xuat_hoa_don_da_tt", "Xuất hóa đơn đã thanh toán")
                ])
        ...
        # ===================== THU HOẠCH =====================
            ...
            if custom_title in ("main_harvest",):
                ...
                commands_to_set = [
                    ...
                    BotCommand("tien_nga_loi_nhuan_thu_hoach", "Lợi nhuận thu hoạch"),
                ]
        ...
        # ===================== HỤI =====================
            ...
            if role == "main":
                ...
                commands_to_set = [
                    ...
                    BotCommand("hui_bao_cao_hui", "Báo cáo hụi theo năm"),
                ]
            else:
